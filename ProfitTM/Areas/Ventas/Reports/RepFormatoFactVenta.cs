...
/// <summary>
/// Summary description for RepFormatoFactVenta
/// </summary>
public class RepFormatoFactVenta : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private XRTableRow detailTableRow2;
    private XRTableCell productDescription;
    private XRTableCell detailTableCell1;
    private XRTableCell detailTableCell2;
    private XRTableCell detailTableCell5;
    ...
    private XRControlStyle evenDetailStyle;
    private XRControlStyle oddDetailStyle;
    private CalculatedField LineTotalCalcField;
    private DevExpress.XtraReports.Parameters.Parameter nmrDesde;
    private DevExpress.XtraReports.Parameters.Parameter nmrHasta;
    ...
    private void InitializeComponent()
    {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RepFormatoFactVenta));
            ...
            this.nmrDesde = new DevExpress.XtraReports.Parameters.Parameter();
            this.nmrHasta = new DevExpress.XtraReports.Parameters.Parameter();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[des_art]")});
            ...
            queryParameter1.Value = new DevExpress.DataAccess.Expression("?nmrDesde", typeof(string));
            queryParameter2.Name = "@sCo_Numero_h";
            queryParameter2.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter2.Value = new DevExpress.DataAccess.Expression("?nmrHasta", typeof(string));
            queryParameter3.Name = "@sCo_Sucursal";
            queryParameter3.Type = typeof(DevExpress.DataAccess.Expression);
            queryParameter3.Value = new DevExpress.DataAccess.Expression("?codSucu", typeof(string));
            ...
            // LineTotalCalcField
            // 
            this.LineTotalCalcField.DataMember = "RepFormatoFacturaVenta";
            this.LineTotalCalcField.DisplayName = "LineTotal";
            this.LineTotalCalcField.Expression = "[prec_vta] * [total_art]";
            ...
            // nmrDesde
            // 
            this.nmrDesde.Description = "N° Desde";
            this.nmrDesde.Name = "nmrDesde";
            // 
            // nmrHasta
            // 
            this.nmrHasta.Description = "N° Hasta";
